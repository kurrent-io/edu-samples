...
var checkpointValueFromRedis = redis.StringGet("checkpoint");                     // Get the checkpoint value from redis
var streamPosition = long.TryParse(checkpointValueFromRedis, out var checkpoint)  // Check if it exists and convertible to long
